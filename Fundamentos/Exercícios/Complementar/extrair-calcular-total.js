...
const resultadofilter = produtos.filter((produto) => produto.emPromocao)
console.log(resultadofilter)

const resultadomap = produtos.map((produto) => produto.preco)
console.log(resultadomap)

const resultadoreduce = resultadomap.reduce((soma, produto) => soma + produto )
